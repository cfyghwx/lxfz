...
class RegressionModel(object):
    ...
    def knn_model_je(self, X_train, X_test, y_train, y_test):
        model = neighbors.KNeighborsRegressor(n_neighbors=3, weights='uniform', algorithm='auto')
    ...
    def gridS(self):
        ...
        gridKnn = GridSearchCV(clf, param_test, cv=10, scoring='neg_mean_absolute_error')
